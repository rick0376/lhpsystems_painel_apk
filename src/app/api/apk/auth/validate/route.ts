    ...
    return NextResponse.json(
      {
        ...
        user: {
          ...
          canAccessRadioManager: authorization.user.canAccessRadioManager,
          canViewRadioDashboard: authorization.user.canViewRadioDashboard,
          canManageAutoDj: authorization.user.canManageAutoDj,
          canViewRadioLibrary: authorization.user.canViewRadioLibrary,
          canUploadRadioTracks: authorization.user.canUploadRadioTracks,
          canDeleteRadioTracks: authorization.user.canDeleteRadioTracks,
          canManageRadioPlaylists: authorization.user.canManageRadioPlaylists,
          canManageRadioSchedules: authorization.user.canManageRadioSchedules,
          canManageRadioIntervals: authorization.user.canManageRadioIntervals,
          canManageRadioSettings: authorization.user.canManageRadioSettings,
          canViewRadioAudit: authorization.user.canViewRadioAudit,
